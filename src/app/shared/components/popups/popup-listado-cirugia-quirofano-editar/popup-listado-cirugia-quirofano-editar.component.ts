...
@Component({
  selector: 'app-popup-listado-cirugia-quirofano-editar',
  templateUrl: './popup-listado-cirugia-quirofano-editar.component.html',
  styleUrls: ['./popup-listado-cirugia-quirofano-editar.component.css']
})
export class PopupListadoCirugiaQuirofanoEditarComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // si tiene observcacion lo guardo en una variable
 ...
 //this.updateDataForm.patchValue(this.config.data);
  ...
  actualizarDatos(){
    ...
    this.config.data.fecha_hora  = formatDate(this.config.data.fecha_hora, 'yyyy-MM-dd HH:mm:ss', 'en') ;
  //  this.updateDataForm.patchValue(this.config.data);
    console.log( this.config.data);
    try {
