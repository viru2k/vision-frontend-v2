...
import { PopupOperacionCobroEditarComponent } from './../../components/popups/popup-operacion-cobro-editar/popup-operacion-cobro-editar.component';
import { PopupOperacionCobroPresentacionEditarRegistroComponent } from './../../components/popups/popup-operacion-cobro-presentacion-editar-registro/popup-operacion-cobro-presentacion-editar-registro.component';
import { PopupMedicoComponent } from './../../components/popups/popup-medico/popup-medico.component';
import { PopupDetalleOperacionCobroDistribucionComponent } from './../../components/popups/popup-detalle-operacion-cobro-distribucion/popup-detalle-operacion-cobro-distribucion.component';
import { PopupOperacionCobroRegistroEditarComponent } from './../../components/popups/popup-operacion-cobro-registro-editar/popup-operacion-cobro-registro-editar.component';


@Component({
  selector: 'app-popup-operacion-cobro-distribucion-multiple-component',
  templateUrl: './popup-operacion-cobro-distribucion-multiple-component.component.html',
  styleUrls: ['./popup-operacion-cobro-distribucion-multiple-component.component.css'],
  providers: [MessageService, DialogService]
})
export class PopupOperacionCobroDistribucionMultipleComponentComponent implements OnInit {
...
loadRegistroByIdLiquidacion(){
  ...
  try {
      this.miServicio.getOperacionCobroRegistrosByLiquidacionNumeroMultiple(this.config.data)
      .subscribe(resp => {
        if (resp[0]) {
          this.realizarFiltroBusqueda(resp);
          this.elementos = resp;
